...
ARM_DRIVER_USART_CMSDK(UART2_CMSDK_DEV, Driver_USART2, UARTTX2_Handler, UARTRX2_Handler, UARTRX2_IRQn, UARTTX2_IRQn);

#endif /* RTE_USART2 */

#if (defined(RTE_USART3) && (RTE_USART3 == 1))

ARM_DRIVER_USART_CMSDK(UART3_CMSDK_DEV, Driver_USART3, UARTTX3_Handler, UARTRX3_Handler, UARTRX3_IRQn, UARTTX3_IRQn);

#endif /* RTE_USART3 */

#if (defined(RTE_USART4) && (RTE_USART4 == 1))

ARM_DRIVER_USART_CMSDK(UART4_CMSDK_DEV, Driver_USART4, UARTTX4_Handler, UARTRX4_Handler, UARTRX4_IRQn, UARTTX4_IRQn);
#endif /* RTE_USART4 */
#endif
